...
export const business_insider = (state = initialState, action) => {
  switch (action.type) {
    case Actions.GET_NEWS_BUSINESS_INSIDER:
      return { ...state, latestUpdate: null, loading: true, error: false };
    case Actions.GET_NEWS_BUSINESS_INSIDER_SUCCESS:
    ...
    case Actions.GET_NEWS_BUSINESS_INSIDER_FAIL:
      return {
        ...state,
        latestUpdate: null,
        loading: false,
